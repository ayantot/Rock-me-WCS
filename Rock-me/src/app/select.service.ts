...
export class SelectService {
  ...
  getPlanet() {
   return [
     ...
     new Planet(10, 2, 'Proxima B',"assets/ProximaB.jpeg", "it is located in the habitable zone" ),
     new Planet (11, 3, 'Draugr',"assets/Draugr.jpeg", "The real name is PSR B1257+12 A"),
     new Planet (12, 3, 'Poltergeist',"assets/Poltergeist.jpeg", "One of the first planets discovered outside the Solar System"),
     new Planet (13, 3, 'Phobetor',"assets/Phobetor.jpeg", "Separated from approximately 2,315 light-years from the Earth"),
